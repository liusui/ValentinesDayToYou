...
- (void)viewDidLoad
{
    ...
    CGRect frame2 = CGRectMake(0, 250, kScreenWidth, kScreenHeight);
    ...
    CGRect frame1 = CGRectMake(150, 250, kScreenWidth, kScreenHeight);
    ...
    CGRect frame3 = CGRectMake(-150, 0, kScreenWidth, kScreenHeight);
...
-(void)readyGo
{
    [UIView animateWithDuration:3 animations:^{
        webView1.frame=CGRectMake(-150, 250, kScreenWidth, kScreenHeight);
        webView2.frame=CGRectMake(-200, 250, kScreenWidth, kScreenHeight);
    }];
