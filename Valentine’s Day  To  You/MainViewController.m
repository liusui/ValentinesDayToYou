...
{
    [super loadView];
    CGRect frame = CGRectMake(-150, 240, kScreenWidth, kScreenHeight);
...
//    [self.view addSubview:iv];
    ...
    CGRect frame1 = CGRectMake(60, 0, kScreenWidth, kScreenHeight);
...
-(void)readyGo
{
    [UIView animateWithDuration:10 animations:^{
       ...
       webView.frame=CGRectMake(rtPoint1.x, rtPoint1.y, kScreenWidth, 4000);
    }];
//    CGPoint rtPoint1=CGPointMake(0, 240);
...
-(void)readyGo1
{
    ...
    CGRect frame2 = CGRectMake(-30, 20, kScreenWidth, kScreenHeight);
    ...
    CGRect frame = CGRectMake(150, 260, kScreenWidth, kScreenHeight);
